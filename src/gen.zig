...
// ── Classification + residency: moved to src/gen_common.zig ────────────────
// Re-exported (and aliased for unqualified use below) so this file stayed a
// pure move. A GGUF-only build gets the same names from src/gen_stub.zig.
...
const FLUX_SEQ_LEN = common.FLUX_SEQ_LEN;
const PAD_TOKEN_FLUX = common.PAD_TOKEN_FLUX;
const fileExists = common.fileExists;
const LTX_GEMMA_REPO_DIR = common.LTX_GEMMA_REPO_DIR;
