...
// Config moved to src/kv_quant_config.zig so a build without MLX can still
// parse --kv-quant. Re-exported (and aliased for unqualified use below) so
// this file stayed a pure move.
pub const config_mod = @import("kv_quant_config.zig");
pub const Scheme = config_mod.Scheme;
pub const KVQuantConfig = config_mod.KVQuantConfig;
